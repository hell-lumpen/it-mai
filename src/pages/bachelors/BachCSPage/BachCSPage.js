      ...
      <div className="container">
        ...
        <div className="content">
          ...
          <p className="section-text">
            Конкурсная группа 01.03.00 "Компьютерные науки и прикладная математика" предлагает два увлекательных направления: "Прикладная математика" и "Прикладная математика и информатика". Здесь студенты получают возможность развивать свои навыки в компьютерных науках и математике.
          </p>
          <p className="section-text">
